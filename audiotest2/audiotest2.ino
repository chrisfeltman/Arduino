...
void loop()
{
   return;
    ...
    if(sample > bufferIndex) 
    {
      long startTime = micros();
      buffer[bufferIndex++] = eepromReadByte();
      long endTime = micros();
...
void copyToEeprom()
{
  ...
  {
    byte data = pgm_read_byte(&sounddata_data[i]);
    Serial.print("writing ");
    Serial.print(data); 
    Serial.print(" to address ");
    Serial.println(i, HEX);
    eepromWriteByte(0x50, i, data);
    delay(5);
  }
